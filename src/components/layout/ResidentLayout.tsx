...
const NAV_ITEMS = [
  { to: '/resident/dashboard', label: 'My Dashboard', icon: '⊞' },
  { to: '/resident/invoices', label: 'Invoices', icon: '📄' },
  { to: '/resident/receipts', label: 'Receipts', icon: '🧾' },
  { to: '/resident/tickets', label: 'My Tickets', icon: '🔧' },
